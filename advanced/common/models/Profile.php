...
class Profile extends \yii\db\ActiveRecord
{
    ...
    const _EDUCATION = [1 => 'Неполное среднее (9 классов)', 2 => 'Среднее (11 классов)', 3 => 'Среднее специальное', 4 => 'Высшее'];
    const _GENDER = [1 => 'Женский', 2 => 'Мужской'];
    const _REGION = [1 => 'г. Москва', 2 => 'Московская область', 3 => 'Другой субъект РФ', 4 => 'Другая страна'];
